...
class DettagliPizzaFioriZucca extends StatelessWidget {
  const DettagliPizzaFioriZucca({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("dettagli pizza fiori zucca"),
        centerTitle: true,
            ...
            const Padding(
              ...
              child: Text(
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit. "
                  ...
                  " posuere, arcu quis interdum ultrices, libero erat sagittis "
                  "quam, eget malesuada neque dolor sit amet arcu. Aenean "
                  "tincidunt, ligula nec luctus dignissim, urna felis pellentesque"
                  " nisl, nec molestie massa sem ut arcu. Cras dui enim, hendrerit "
                  "vitae magna eget, ultricies luctus ligula. Vivamus sit amet orci"
                  " cursus, porta massa a, dictum odio. Mauris in arcu lorem.",
                style: TextStyle(
                  fontSize: 16,
                ),
              ),
