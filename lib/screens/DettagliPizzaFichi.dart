...
class DettagliPizzaFichi extends StatelessWidget {
  const DettagliPizzaFichi({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("dettagli pizza fichi"),
      ),
      body: Center(
        child: Column(
          children: [
            Image.asset(
                "images/pizza_fichi.png",
              width: 210,
              height: 210,
            ),
            const Padding(
